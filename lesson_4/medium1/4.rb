...
# and one called Goodbye. The Hello class should have a hi instance method that
# takes no arguments and prints "Hello". The Goodbye class should have a bye
# instance method to say "Goodbye". Make use of the Greeting class greet method
